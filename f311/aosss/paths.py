...
def get_aosss_path(*args):
  """Returns full path ftaosss package. Arguments are added at the end of os.path.join()"""
...
def get_aosss_data_path(*args):
    """Returns path to ftaosss scripts. Arguments are added to the end os os.path.join()"""
