...
class XToScalar(XHelpDialog):
    ...
    def __init__(self, *args):
        ...
        self.help_data = a99.collect_doc(ao.blocks.toscalar, base_class=ao.blocks.base.ToScalar)
    ...
    def accept(self):
        try:
            ...
            symbols_available = a99.module_to_dict(ao.blocks.toscalar)
            import numpy as np
            symbols_available["np"] = np
            block = eval(expr.strip(), symbols_available)

            if not isinstance(block, ao.blocks.base.ToScalar):
