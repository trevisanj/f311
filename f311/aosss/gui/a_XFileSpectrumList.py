...
class XFileSpectrumList(a99.XFileMainWindow):
    def __init__(self, parent=None, fileobj=None):
        ...
        self.clsss[0] = tuple([ao.FileSpectrumList, ao.FileFullCube]+ex.classes_sp())  # file types that can be opened
        self.wilds[0] = "*.splist"
        ...
        if os.path.isfile(ao.FileSpectrumList.default_filename):
    ...
    def _filter_on_load(self, f):
        ...
        elif isinstance(f, a99.FileSpectrum):
            f1 = ao.FileSpectrumList()
