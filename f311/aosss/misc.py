...
FILE_MAP = OrderedDict((
 ...
 ("cube_seeing", a99.FileFits),
 ("ifu_noseeing", ao.FileFullCube),
 ("mask_fiber_in_aperture", a99.FileFits),  # TODO, handle this file because it is nice
 ("reduced", ao.FileFullCube),
 ("reduced_snr", ao.FileFullCube),
 ("sky", a99.FileSpectrumFits),
 ("skysub", a99.FileSpectrumFits),
 ("spintg", a99.FileSpectrumFits),
    ...
    for keyword, class_ in list(FILE_MAP.items()):
        ...
        if flag_exists:
            if class_ == "messed":
                ...
                sp = a99.load_spectrum_fits_messed_x(fn, sp_ref)
                if sp:
                    fileobj = a99.FileSpectrum()
                    fileobj.spectrum = sp
            elif flag_supported:
                fileobj = class_()
                try:
