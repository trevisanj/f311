...
def _new_honllondon(key, mol_consts):
    ...
    LAML = mol_consts["from_spdf"]
    LAM2L = mol_consts["to_spdf"]
    AL = mol_consts["statel_A"]
    AEL = mol_consts["statel_alpha_e"]
    BEL = mol_consts["statel_B_e"]
    A2L = mol_consts["state2l_A"]
    AE2L = mol_consts["state2l_alpha_e"]
    BE2L = mol_consts["state2l_B_e"]
